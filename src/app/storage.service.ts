...
Kello:Tää on vähän hankalampi. Tarvis sellaisen joka on päällä ylöspäin juoksevasti 3 min – 2 min – 7 min
  ...
  getTimers(): any[] {
    return [
      ...
      { id: '2025-4-wm2', name: 'SIIVOUSPÄIVÄ W 50 45+', type: 'interval', prep: 0, work: 5, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { id: '2025-4-mm2', name: 'SIIVOUSPÄIVÄ M 50 45+', type: 'interval', prep: 0, work: 5, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { id: '2025-4-wm1', name: 'SIIVOUSPÄIVÄ W 40 35+', type: 'interval', prep: 0, work: 5, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { id: '2025-4-mm1', name: 'SIIVOUSPÄIVÄ M 40 35+', type: 'interval', prep: 0, work: 3, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { id: '2025-4-wrx', name: 'SIIVOUSPÄIVÄ W',        type: 'interval', prep: 0, work: 5, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { id: '2025-4-mrx', name: 'SIIVOUSPÄIVÄ M',        type: 'interval', prep: 0, work: 5, rest: 3, logo: 'images/nocco-logo-w.png', weights: 'ub2025-e2-weights.png', },
      { 
        id: '2025-5m', 
        name: 'LEGENDOJEN LOPPUNÄYTÖS', 
        type: 'stopwatch', prep: 10, time: 600,
        logo: 'images/teho-logo-w.png', 
      },
      { 
        id: '2025-5rx', 
        name: 'ARRIN SYNTYMÄPÄIVÄ', 
        type: 'stopwatch', prep: 10, time: 300,
        logo: 'images/wisegym-logo.png', 
      },
      { 
        id: '2025-6', 
        name: 'PYSSYHIIHTO', 
        type: 'stopwatch', prep: 10, time: 960,
        logo: 'images/erg-sport-logo.png', 
      },
      { 
        id: '2025-7', 
        name: 'MINÄ PYSTYN MINÄ HALUAN', 
        type: 'stopwatch', prep: 10, time: 360,
        logo: 'images/icaniwill-logo.png', 
      },
    ];
  }
